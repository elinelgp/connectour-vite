...
export const mockVenuesData: IVenue[] = [
  {
    ...
    description: 'Salle mythique parisienne accueillant les plus grands concerts rock et metal. Acoustique exceptionnelle et capacité impressionnante.',
  ...
  },
  {
    id: 'venue-002',
    name: 'La Cigale',
    description: 'Club historique du quartier Pigalle. Ambiance intimiste pour des concerts inoubliables.',
    type: VenueType.CLUB,
  ...
  },
  {
    id: 'venue-003',
    name: 'Le Bataclan',
    description: 'Salle de spectacle emblématique avec une programmation éclectique. Architecture unique et son exceptionnel.',
  ...
  },
  {
    id: 'venue-005',
    name: 'Le Trabendo',
    description: 'Salle de concert moderne dans le parc de la Villette. Idéale pour découvrir de nouveaux talents.',
    type: VenueType.CLUB,
    address: '211 Avenue Jean Jaurès',
    city: 'Paris',
    country: 'France',
...
export const mockEventsData: IEvent[] = [
  {
    ...
    description: 'Concert exceptionnel de The Electric Storm présentant leur nouvel album "Thunder & Lightning". Une soirée électrique garantie !',
  ...
  },
  {
    ...
    description: 'Soirée exceptionnelle réunissant deux des plus grands noms du rock français. Une nuit mémorable en perspective.',
  ...
  },
  {
    ...
    description: 'Soirée de lancement du nouvel EP "Anarchy Rising". Concert intimiste dans une ambiance punk explosive.',
  ...
  },
  {
    ...
    description: 'Premier jour du Hellfest avec une programmation de légende. Iron Wolves en tête d\'affiche !',
  ...
  },
  {
    ...
    description: 'Concert immersif avec projections visuelles. Découvrez l\'univers progressif de Nebula Sounds.',
